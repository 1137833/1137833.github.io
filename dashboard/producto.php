  ...
  <body>
    ...
    <header>
      <div class="contenedor">
        <img src="img/img2/7.jpeg" alt="">
        <h1><div class="centrado">PRODUCTOS</div></h1>
      </div>
    </header>

    <section style="padding: 50px 31.5px 25px 31.5px;">
      <div class="container">
          <h6 style="text-align: center;">Nuestros</h6>
          <h4 style="text-align: center; color: #900c3f;">Grandes Productos</h4>
          <hr style="width: 250px; border-color: #333333; padding-top: 20px;">
      </div>
    </section>

    <section style="padding: 20px 31.5px 25px 31.5px;">
        <div class="container">
            <div class="row" style="text-align: center;">
                <div class="col-md-4" style="padding: 0px 15px 75px 0px;">
                    <div class="zoom" style="font-size: 24px; margin: 0px 0px 15px;">
                        <a href="descripcion.php"><img src="img/img2/product.jpeg" alt="" style="width: 340px; height: 230px;"></a>
                    </div>
                    <div class="col"> 
                        <p>MC 2020</p>
                        <p>S/. 199.90</p>
